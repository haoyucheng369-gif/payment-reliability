...
using ReliablePaymentProcessing.Application.Security;
using ReliablePaymentProcessing.ProviderMock;
...
builder.Services
    ...
    {
        resource.AddService("ReliablePaymentProcessing.ProviderMock");
    })
    .WithTracing(tracing =>
    {
        tracing
    ...
    CancellationToken cancellationToken) =>
{
    ...
    var logger = loggerFactory.CreateLogger("ReliablePaymentProcessing.ProviderMock");
    ...
    _ = Task.Run(async () =>
    {
        ...
        using var webhookActivity = ReliablePaymentProcessingTelemetry.ActivitySource.StartActivity(
